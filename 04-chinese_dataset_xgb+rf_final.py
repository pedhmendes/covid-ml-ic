...
"""Fiding NaN values in my dataset, without the ones with NaN% > 20%"""
...
if (save == 0):
    plt.savefig('missing_data_2.png')
...
def bp_feature_plot(XPLOT, YPLOT, filename):
    fig = plt.figure(figsize=(12, 5))

    plt.title('Outcome and '+ XPLOT.name, fontsize=30)
  
    sns.boxplot(x=XPLOT, y=YPLOT, orient='h')
...
out = ['Deaths' if i == 1 else 'Survivals' for i in df['outcome']]

bp_feature_plot(df['Lactate_dehydrogenase'], out, "lactate.png")

bp_feature_plot(df['neutrophils(%)'], out, "neutr.png")

bp_feature_plot(df['(%)lymphocyte'], out, "lymp.png")

bp_feature_plot(df['procalcitonin'], out, "proc.png")

bp_feature_plot(df['neutrophils_count'], out, "neu-c.png")
